...
$tabledit->fields_in_list_view = array('id','letter','category','url','fonta','hashtag','title','status','subcategory');
...
$tabledit->fields_required = array('letter','category','url','fonta','hashtag','title','status','subcategory');
