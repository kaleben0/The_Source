...
$tabledit->fields_in_list_view = array('id','main_url','city','state','country_code','zip_code','morning_message','day_message','dusk_message','evening_message','spot_url','privatebin_url','shellinabox_url','google_embed');
...
$tabledit->fields_required = array('id','main_url','city','state','country_code','zip_code','morning_message','day_message','dusk_message','evening_message','spot_url','privatebin_url','shellinabox_url','google_embed');
...
$tabledit->help_text = array(
	'zip_code' => '10 Digits Max',
	'google_embed' => 'https://calendar.google.com/calendar/embedhelper',
	'city' => 'Lowercase i.e "detroit',
	'state' => 'Lowercase, i.e "mi',
	'country_code' => 'Lowercase, i.e "us"',
);
...
$tabledit->show_text = array(
	...
	'day_message' => 'Day Message',
	'dusk_message' => 'Dusk Message',
	'evening_message' => 'Evening Message',
	'spot_url' => 'Spotify Playlist',
	'privatebin_url' => 'PrivateBin URL',
	'shellinabox_url' => 'Shellinabox URL',
	'google_embed' => 'Google Calendar Embed',
);
