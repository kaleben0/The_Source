...
<form action="./functions/add_frames.php" method="post" id="frame_form">
  ...
  <div class="frame_field">Title
    <input type="text" class="set_fields" name="frame2_title" value="<?php include './functions/config_frames.php';echo$frame2_title ?>">
  </div>
  <div class="frame_field">URL
  ...
  <div class="frame_field">Title
    <input type="text" class="set_fields" name="frame3_title" value="<?php include './functions/config_frames.php';echo$frame3_title ?>">
  </div>
  <div class="frame_field">URL
  ...
  <div class="frame_field">Title
    <input type="text" class="set_fields" name="frame4_title" value="<?php include './functions/config_frames.php';echo$frame4_title ?>">
  </div>
  <div class="frame_field">URL
  ...
  <div class="frame_field">Title
    <input type="text" class="set_fields" name="frame5_title" value="<?php include './functions/config_frames.php';echo$frame5_title ?>">
  </div>
  <div class="frame_field">URL
