...
echo "<input type='url' name='url' class='book_update_field' placeholder='Full URL'value='$url'>";
echo "<i class='fab fa-font-awesome-alt input_fa_icon' onclick='toggle_fa();'></i><input type='text' name='fonta' class='book_update_field set_input_fa' placeholder='Font Awesome Icon' value='$fonta'>";
