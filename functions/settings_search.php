...
echo "<div class='set_label'>Search $id  <div class='tooltip'><i class='fas fa-info-circle fa-sm'></i><span class='tooltiptext'>Change Title to 'empty' (without quotes) to disable</span></div><input type='submit' name='submit' class='far fa-save button_save' value='&#xf0c7' title='Save Changes'></div>";
...
echo "<div class='frame_field'>Font Awesome Icon <i class='fab fa-font-awesome-alt set_fa_search' onclick='toggle_fa();'></i><input type='text' class='set_fields set_input_fa' name='search_icon' value='$search_icon'></div>";
echo "</form></br>";
          }
          $result->free();
        }
