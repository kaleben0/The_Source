<div class="top_nav">
  ...
  <div class="tzone"><span id="txt"></span>&nbsp;|&nbsp<i class="fas fa-cogs fa-1x" onclick="togglesettings();"></i>&nbsp;|&nbsp;<i class="fas fa-cloud-sun fa-1x"></i>&nbsp;|&nbsp<span id="time_message">Good Morning</span>&nbsp;|&nbsp<i class="fas fa-user-cog" onclick="window.open('./htam-panel.php','_blank')""></i></div>
