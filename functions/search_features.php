...
<div class="settings_box" id="set_pdsearch">
  <div class="settings_search_features settings_search_container" >
    <?php
        ...
        echo "<div class='feat_container'><div class='feat_title'>$title</div><div class='feat_url' onclick='update_db();'><a href='$change?id=$id&title=$title&status=$status' target='_blank' id='search_feature_form' onclick='update_db();'><i class='$sub_icon' style='color:$color !important;'></i></a></div></div>";
          }
          $result->free();
        }
?>
