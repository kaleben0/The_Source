...
<div class="win_sc"><span class="exit_sc"><i class="fas fa-window-close fa-lg"></i></span>
  ...
  <div class="sc_container">
    ...
    <hr/>
    <div class="sc_box"><span class="sc_function dexter">Dexter</span><span class="main_key"> Ctrl </span><i class="fas fa-plus"></i><span class="main_key"> Alt </span><i class="fas fa-plus"></i><span class="sec_key">U</span></div>
    <div class="sc_box"><span class="sc_function chicago">Chicago</span><span class="main_key"> Ctrl </span><i class="fas fa-plus"></i><span class="main_key"> Alt </span><i class="fas fa-plus"></i><span class="sec_key">I</span></div>
    <div class="sc_box"><span class="sc_function dallas">Dallas</span><span class="main_key"> Ctrl </span><i class="fas fa-plus"></i><span class="main_key"> Alt </span><i class="fas fa-plus"></i><span class="sec_key">O</span></div>
    <div class="sc_box"><span class="sc_function seattle">Seattle</span><span class="main_key"> Ctrl </span><i class="fas fa-plus"></i><span class="main_key"> Alt </span><i class="fas fa-plus"></i><span class="sec_key">P</span></div>
  </div>
</div>
