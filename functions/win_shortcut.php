...
echo "<div class='sc_box' id='$frame1_title'><span class='sc_function'>$frame1_title</span><span class='main_key'> Ctrl </span><i class='fas fa-plus'></i><span class='main_key'> Alt </span><i class='fas fa-plus'></i><span class='sec_key'>5</span></div>";
echo "<div class='sc_box' id='$frame2_title'><span class='sc_function'>$frame2_title</span><span class='main_key'> Ctrl </span><i class='fas fa-plus'></i><span class='main_key'> Alt </span><i class='fas fa-plus'></i><span class='sec_key'>6</span></div>";
echo "<div class='sc_box' id='$frame3_title'><span class='sc_function'>$frame3_title</span><span class='main_key'> Ctrl </span><i class='fas fa-plus'></i><span class='main_key'> Alt </span><i class='fas fa-plus'></i><span class='sec_key'>7</span></div>";
